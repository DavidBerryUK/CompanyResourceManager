...
{
    public class JobRoleExtendedCrudService : BaseExtendedCrudService<JobRole, JobRoleSummary, JobRoleExtended, Guid>,
        IJobRoleCrudService
    {

        public JobRoleExtendedCrudService(CrmDatabaseContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
