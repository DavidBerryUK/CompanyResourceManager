...
{
    public class ContactValidationCrudService : BaseCrudService<ContactValidation, ContactValidationSummary, Guid>,
        IContactValidationCrudService
    {
        public ContactValidationCrudService(CrmDatabaseContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }
