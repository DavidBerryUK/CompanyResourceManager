...
export default class BaseViewPage<T extends IApiModel> extends BasePage implements IComponentMetaData {
  ...
  // IComponentMetaData
  public componentName: string = 'BaseViewPage';
  public componentDescription: string = 'BaseViewPage';
  // IComponentMetaData
      ...
      .yesPressed(() => {
        ...
        this.repository
          ...
          .onFailed((message: string) => {
            ...
            failureDialog.createWithParameters(`Restore ${this.model.entityName}`,
