        ...
        <v-card width="100%">
          <v-list two-line>
            <template v-for="item in filteredList.items">
                ...
                <v-list-tile-content>
                  <div
                    ...
                    <v-list-tile primary-title>
                      <div>
                      <div :class="theme.listTitleStyle">{{item.description}}</div>
                      <div :class="theme.listBodyStyle">{{item.assetTypeName}}</div>
                    </div>
                  </v-list-tile>
              ...
              <v-divider :key="item.assetId + '_'"></v-divider>
            </template>
          </v-list>
        </v-card>
      </v-layout>
...
<script lang="ts" src='./AssetList.ts'></script>