<template>
  <div class="scrollable-list">
    <v-toolbar color="purple" dark class="scroll-header">
      <v-toolbar-title>Asset Types</v-toolbar-title>
      <v-spacer></v-spacer>
        ...
        <v-card width="100%">
          <v-list two-line>
            <template v-for="item in filteredList.items">
              ...
              >
                <v-list-tile-content>
                  ...
                  <v-list-tile primary-title>
                      ...
                      <div v-if="item.hasAssetBadge" :class="theme.listFooterStyle">Tacked with Asset Badge</div>
                    </div>
                  </v-list-tile>
              ...
              <v-divider :key="item.assetTypeId + '_'"></v-divider>
            </template>
          </v-list>
        </v-card>
      </v-layout>
...
<script lang="ts" src='./AssetTypeList.ts'></script>