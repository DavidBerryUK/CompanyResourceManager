...
import ObjectMapperSecurityGroupExtendedModel   from '@/repositories/objectMappers/securityGroup/ObjectMapperSecurityGroupExtendedModel';
...
export default class SecurityGroupEdit extends BaseEditPage<SecurityGroupSummaryModel>
  ...
  constructor() {
    super(
      ...
      new ObjectMapperSecurityGroupExtendedModel());
  }
