...
/// F = List Filter Model
export default class GenericApiExtendedRepository<S extends IApiModel, E extends S, F> extends ApiBase {
  ...
  public constructor(
    ...
    if ( objectExtendedModelFactory === null || objectExtendedModelFactory === undefined ) {
      throw new Error('Can not create GenericApiExtendedRepository without an Extended Object Factory');
    }
